...
const LESSONS: LessonDef[] = [
  {
    ...
    questions: [
      { externalId: "q1", qtype: "mcq", difficulty: "medium", correct: "False" },
      ...
      { externalId: "q5", qtype: "mcq", difficulty: "medium", correct: "WHATWG" },
      { externalId: "q6", qtype: "mcq", difficulty: "medium", correct: "Structuring content and giving it meaning" },
      { externalId: "q7", qtype: "mcq", difficulty: "medium", correct: "Hyper Text Markup Language" },
      { externalId: "q8", qtype: "mcq", difficulty: "medium", correct: "Adding complex interactivity and logic" },
      { externalId: "q9", qtype: "mcq", difficulty: "medium", correct: "An in-memory tree representation of the HTML" },
      { externalId: "q10", qtype: "mcq", difficulty: "medium", correct: "False" }
    ],
    task: {
      title: "Hello Web",
      starterCode: {
  ...
  },
  {
    ...
    questions: [
      { externalId: "q1", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q2", qtype: "mcq", difficulty: "medium", correct: "The browser renders in quirks mode" },
      { externalId: "q3", qtype: "mcq", difficulty: "medium", correct: "<head>" },
      { externalId: "q4", qtype: "mcq", difficulty: "medium", correct: "One" },
      { externalId: "q5", qtype: "mcq", difficulty: "medium", correct: "It causes inconsistent rendering and box-model behavior" },
      { externalId: "q6", qtype: "mcq", difficulty: "medium", correct: "html → head → body" },
      { externalId: "q7", qtype: "mcq", difficulty: "medium", correct: "Contains metadata about the document" },
      { externalId: "q8", qtype: "mcq", difficulty: "medium", correct: "Visible and interactive content" },
      { externalId: "q9", qtype: "mcq", difficulty: "medium", correct: "Browsers may silently move it to <body> or ignore it" },
      { externalId: "q10", qtype: "mcq", difficulty: "medium", correct: "To tell the browser to render in standards mode" }
    ],
    task: {
  ...
  },
  {
    ...
    questions: [
      { externalId: "q1", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q2", qtype: "mcq", difficulty: "medium", correct: "disabled" },
      { externalId: "q3", qtype: "mcq", difficulty: "medium", correct: "Crossed" },
      { externalId: "q4", qtype: "mcq", difficulty: "medium", correct: "Element = opening tag + content + closing tag; tag = just the markers" },
      { externalId: "q5", qtype: "mcq", difficulty: "medium", correct: "<br>" },
      { externalId: "q6", qtype: "mcq", difficulty: "medium", correct: "The trailing slash is optional and purely stylistic" },
      { externalId: "q7", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q8", qtype: "mcq", difficulty: "medium", correct: "Browsers may fix it silently but it's invalid and unpredictable" },
      { externalId: "q9", qtype: "mcq", difficulty: "medium", correct: "<div>" },
      { externalId: "q10", qtype: "mcq", difficulty: "medium", correct: "An attribute whose mere presence means true" },
      { externalId: "q11", qtype: "mcq", difficulty: "medium", correct: "" },
      { externalId: "q12", qtype: "mcq", difficulty: "medium", correct: "The page fails to load at all" }
    ],
    task: {
  ...
  },
  {
    ...
    questions: [
      { externalId: "q1", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q2", qtype: "mcq", difficulty: "medium", correct: "<, >, &" },
      { externalId: "q3", qtype: "mcq", difficulty: "medium", correct: "Copyright symbol" },
      { externalId: "q4", qtype: "mcq", difficulty: "medium", correct: "The browser may interpret it as markup" },
      { externalId: "q5", qtype: "mcq", difficulty: "medium", correct: "Wrong case may not resolve correctly" },
      { externalId: "q6", qtype: "mcq", difficulty: "medium", correct: "&#60;" },
      { externalId: "q7", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q8", qtype: "mcq", difficulty: "medium", correct: "&nbsp;" },
      { externalId: "q9", qtype: "mcq", difficulty: "medium", correct: "&amp;" },
      { externalId: "q10", qtype: "mcq", difficulty: "medium", correct: "They are visible in page source" }
    ],
    task: {
  ...
  },
  {
    ...
    questions: [
      { externalId: "q1", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q2", qtype: "mcq", difficulty: "medium", correct: "<meta charset=\"UTF-8\">" },
      { externalId: "q3", qtype: "mcq", difficulty: "medium", correct: "<title>" },
      { externalId: "q4", qtype: "mcq", difficulty: "medium", correct: "The site looks zoomed out with tiny text" },
      { externalId: "q5", qtype: "mcq", difficulty: "medium", correct: "To avoid encoding issues and re-parsing" },
      { externalId: "q6", qtype: "mcq", difficulty: "medium", correct: "<meta name=\"description\">" },
      { externalId: "q7", qtype: "mcq", difficulty: "medium", correct: "To enable correct mobile rendering" },
      { externalId: "q8", qtype: "mcq", difficulty: "medium", correct: "Virtually all characters and emoji from all languages" },
      { externalId: "q9", qtype: "mcq", difficulty: "medium", correct: "<title> sets browser tab text, <h1> is visible on-page heading" },
      { externalId: "q10", qtype: "mcq", difficulty: "medium", correct: "Matches CSS viewport width to the device width" }
    ],
    task: {
  ...
  },
  {
    ...
    questions: [
      { externalId: "q1", qtype: "mcq", difficulty: "medium", correct: "False" },
      { externalId: "q2", qtype: "mcq", difficulty: "medium", correct: "en-US" },
      { externalId: "q3", qtype: "mcq", difficulty: "medium", correct: "rtl" },
      { externalId: "q4", qtype: "mcq", difficulty: "medium", correct: "When part of a page is in a different language" },
      { externalId: "q5", qtype: "mcq", difficulty: "medium", correct: "To select correct pronunciation rules" },
      { externalId: "q6", qtype: "mcq", difficulty: "medium", correct: "Arabic, Hebrew" },
      { externalId: "q7", qtype: "mcq", difficulty: "medium", correct: "A standard for language identifiers" },
      { externalId: "q8", qtype: "mcq", difficulty: "medium", correct: "ltr" },
      { externalId: "q9", qtype: "mcq", difficulty: "medium", correct: "It may not work as expected" },
      { externalId: "q10", qtype: "mcq", difficulty: "medium", correct: "It can flip margins, padding, and flex/grid direction" }
    ],
    task: {
